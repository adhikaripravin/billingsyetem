...
class login_sys:
    def __init__(self,root):
        ...
        self.root.geometry("500x550+200+200")
        ...
        #form title
        label_title = Label(self.root,text="Registration Form",bg="#7F525D",width = 20,font=("Myraid pro",20,"bold"))
        label_title.place(x=90,y=53)

        label_fname = Label(self.root,text="First name", width=20,bg="#7F525D",font=("Myraid pro",10,"bold")).place(x=64,y=130)
        ...
        label_lname = Label(self.root,text="Last name", width=20,bg="#7F525D",font=("Myraid pro",10,"bold")).place(x=62,y=190)
        ...
        label_contact = Label(self.root,text="Contact", width=20,bg="#7F525D",font=("Myraid pro",10,"bold")).place(x=57,y=250)
        ...
        label_email = Label(self.root,text="Email", width=20,bg="#7F525D",font=("Myraid pro",10,"bold")).place(x=53,y=310)
        ...
        #entry_email.config(validate="key", validatecommand=(validate_email,"%P"))

        label_password = Label(self.root,text="Password", width=20,bg="#7F525D",font=("Myraid pro",10,"bold")).place(x=62,y=370)
        ...
        #entry_password.config(validate="key", validatecommand=(validate_password,"%P"))

        label_conpassword = Label(self.root,text="Confirm Password", width=20,bg="#7F525D",font=("Myraid pro",10,"bold")).place(x=81,y=430)
        ...
        if (x == True) and (y == True):
            try:
                   ...
                   if row!=None:
                       ...
                       cur.execute("insert into register (f_name, l_name, contact, email, password, confirm_password) values(%s,%s,%s,%s,%s,%s)",
